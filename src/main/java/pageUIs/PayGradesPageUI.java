...
public class PayGradesPageUI {
	...
	public static final String DYNAMIC_EDIT_BUTTON_BY_GRADE = "//div[text()='Grade 2']/parent::div/following-sibling::div[2]//i[contains(@class,'bi-pencil')]";
	...
	public static final String CURRENCY_SAVE_BUTTON = "//h6[text()='Add Currency']/parent::div//button[@type='submit']";
	...
	public static final String MINIMUM_SALARY_ROW_LABEL = "//div[@role='cell'][3]/div";
	public static final String MAXIMUM_SALARY_ROW_LABEL = "//div[@role='cell'][4]/div";
	public static final String ADD_CURRENCY_LABEL = "//h6[text()='Add Currency']";
